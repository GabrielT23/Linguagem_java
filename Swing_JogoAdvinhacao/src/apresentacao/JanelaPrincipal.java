...
public class JanelaPrincipal extends JFrame {
	...
	public static final String JANELA_NOME = "Digite seu nome: ";
	...
	private JLabel criaPainelMensagem() {
	    ...
	    msg.append(name);
		JLabel lbResposta = new JLabel("Bem-vindo "+msg+"!");
			...
			if(jogo.terminou())
				...
				try {
					...
					if(jogo.terminou()) {
						...
						lbResposta.setText("Você já realizou " + jogo.getTentativas() + " tentativas // "+"ultimo valor:"+palpite);
					}
